...
<article class="core-schedule-feed-manage-item-content" id="js_schedule_item_{$aScheduleItem.schedule_id}">
    <div class="item-outer">
        <div class="item-inner">
             ...
             {if empty($aScheduleItem.is_temp)}onclick="tb_show('{_p var='edit_your_item'}', $.ajaxBox('core.editScheduleItem', 'height=400&amp;width=600&amp;id={$aScheduleItem.schedule_id}')); return false;"{/if}></div>
                    ...
                    {if empty($aScheduleItem.is_temp)}
                        <div class="item-actions">
                            <span class="item-delete">
                                <a href="#" title="{_p var='delete'}" class="item-action-btn" onclick="$Core.jsConfirm({l}message: '{_p var='are_you_sure_you_want_to_delete_this_scheduled_item'}'{r}, function(){l}$.ajaxCall('core.deleteScheduleItem', 'height=400&amp;width=600&amp;id={$aScheduleItem.schedule_id}'){r}, function(){l}{r}); return false;">
