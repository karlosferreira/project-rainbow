...
$Core.feed = {
    ...
    hideFeed: function (aFeedIds, aUserIds) {
        aFeedIds.forEach(function (id) {
            ...
            var hide_all_phrase = oTranslations['hide_all_from_full_name'].replace('{full_name}', $Core.htmlEntityEncode($('#hide_feed_' + id).data('user-full_name')));
        ...
        aUserIds.forEach(function (id) {
            ...
            var undo_phrase = oTranslations['you_wont_see_posts_from_full_name_undo'].replace('{full_name}', '<a href="javascript:void(0);" onclick="return $Core.feed.linkToUser(' + id + ');">' + $Core.htmlEntityEncode($('#' + hide_feed_id).data('user-full_name')) + '</a>').replace('{undo}', '<a href="javascript:void(0)" onclick="$Core.feed.unhideAllFromUser(' + id + ')">' + oTranslations['undo'] + '</a>');
