...
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aFriend'],'suffix' => '_120_square','max_width' => 50,'max_height' => 50,'class' => 'js_hover_title')); ?>
<?php endif; ?>
		</div>
	</li>	
...
<?php if ($this->_aVars['iRemainCount'] > 0): ?>
	<li class="user_rows view-friend-more">
		<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('profile.friend', array('view' => 'online'), false, false); ?>">+<?php echo $this->_aVars['iRemainCount']; ?></a>
	</li>
<?php endif; ?>
</ul>
<?php else: ?>
