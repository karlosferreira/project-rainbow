...
<?php if ($this->_aVars['bParent']): ?>
        <ul class="action">
            <li>
                <a href="<?php if ($this->_aVars['aCallback'] === null):  echo Phpfox::getLib('phpfox.url')->makeUrl('photo', [], false, false);  else:  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aCallback']['url_home'], [], false, false);  endif; ?>" class="js_photo_category"><?php echo _p('all_categories'); ?></a><?php endif; ?>
