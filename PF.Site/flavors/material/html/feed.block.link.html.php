...
<ul class="dropdown-menu dropdown-menu-right">
    {if $aFeed.type_id == "user_status" && ((Phpfox::getUserParam('feed.can_edit_own_user_status') && $aFeed.user_id == Phpfox::getUserId()) || Phpfox::getUserParam('feed.can_edit_other_user_status'))}
        <li class=""><a href="#" class="" data-privacy-editable="1" data-id="{$aFeed.feed_id}" onclick="tb_show('{_p var='edit_your_post'}', $.ajaxBox('feed.editUserStatus', 'height=400&amp;width=600&amp;id={$aFeed.feed_id}')); return false;">
	...
	{if Phpfox::isUser() && Phpfox::isModule('report') && isset($sFeedType) && isset($aFeed.report_module) && !User_Service_Block_Block::instance()->isBlocked(null, $aFeed.user_id)}
