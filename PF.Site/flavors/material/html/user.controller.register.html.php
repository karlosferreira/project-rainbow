            ...
            <form method="post" class="form" action="{url link='user.register'}">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="invite_email" class="form-control" placeholder="{if Phpfox::getParam('core.enable_register_with_phone_number')}{_p var='your_email_phone_number'}{else}{_p var='your_email'}{/if}" name="val[invite_email]" value="" />
                    </div>
                </div>
