        ...
        {foreach from=$aCategories item=aCategory}
            ...
            <div class="block_clear">
                ...
                <div class="content clearfix">
                    <div class="item-container page-listing page-home collapse in" aria-expanded="true" id="item-collapse-page-grid-{$aCategory.type_id}">
                        ...
                        <div class="item-members">
                            {if ($aPage.total_members - 4) > 0}
                                {foreach from=$aPage.members item=aMember key=iKey}
                                    {if $iKey < 3}
                                        {img user=$aMember suffix='_120_square'}
                                    {/if}
                                {/foreach}
