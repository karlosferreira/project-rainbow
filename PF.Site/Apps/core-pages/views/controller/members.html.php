    ...
    <div class="item-page-search-header">
        <div class="item-page-search-member input-group">
            <input class="form-control" type="search" placeholder="{_p var='search_member'}"
                   ...
                   data-listing-container=".pages-member-listing" data-page-id="{$iPageId}"
            />
...
<div class="tab-content">
    <div class="tab-content pages-member-container pages-member-listing">
        {module name='pages.search-member' tab='all' page_id=$iPageId container='.pages-member-listing'}
    </div>
</div>
