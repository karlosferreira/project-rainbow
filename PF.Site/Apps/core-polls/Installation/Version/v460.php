    ...
    public function process()
    {
        ...
        $aMetaKeys = [
            'poll_meta_description' => array(
                'description' => '<title>Poll Meta Description</title><info>Meta description added to pages related to the Polls app. <a role="button" onclick="$Core.editMeta(\'seo_poll_meta_description\', true)">Click here</a> to edit meta description.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="poll_meta_description"></span></info>',
                'meta_value' => 'Share your polls with friends, family, and the world on Site Name.c'
            ),
            'poll_meta_keywords' => array(
                'description' => '<title>Poll Meta Keywords</title><info>Meta keywords that will be displayed on sections related to the Polls app. <a role="button" onclick="$Core.editMeta(\'seo_poll_meta_keywords\', true)">Click here</a> to edit meta keywords.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="poll_meta_keywords"></span></info>',
