...
{if isset($bIsViewingPoll)}
    <div class="item_info pr-3">
        {img user=$aPoll suffix='_120_square'}
    ...
    {elseif $aPoll.close_time}
        <div class="alert alert-info">
            {_p var='voting_for_this_poll_available_until'}: {if Phpfox::isModule('feed')}{$aPoll.close_time|date:'feed.feed_display_time_stamp'}{else}{$aPoll.close_time|date:'core.global_update_time'}{/if}
        </div>
    {/if}
    ...
    <div class="item-content mb-2 mt-1">
        ...
        <div class="item_view_content">
            {$aPoll.description|parse|shorten:500:'feed.view_more':true|split:55}
        </div>
    </div>
		...
		{if !isset($bIsViewingPoll)}
            <div class="row_title">
                ...
                <div class="row_title_image">
                    {img user=$aPoll suffix='_120_square' max_width=50 max_height=50}
