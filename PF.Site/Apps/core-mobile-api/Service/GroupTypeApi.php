...
use Apps\Core_MobileApi\Api\Form\Group\GroupTypeForm;
...
class GroupTypeApi extends AbstractResourceApi
{
    /**
     * @var Facade
     */
    ...
    function findOne($params)
    {
        ...
        return $this->success(GroupTypeResource::populate($category)->toArray());
    }
    ...
    function form($params = [])
    {
        ...
        if ($editId) {
            ...
            $form->setTitle('edit_a_category')
                ->setAction(UrlUtility::makeApiUrl('group-type/:id', $editId))
                ->setMethod('PUT');
    ...
    function create($params)
    {
        ...
        if ($form->isValid()) {
            ...
            if ($id) {
                return $this->success([
                    'id'            => $id,
                    'resource_name' => GroupTypeResource::populate([])->getResourceName()
                ]);
            } else {
    ...
    function delete($params)
    {
        ...
        if ($params['child_action'] == 'move') {
            ...
            $this->groupService->moveItemsToAnotherCategory($params['id'], $sub[0], false,
    ...
    {
        return GroupTypeResource::populate($item)->setViewMode(ResourceBase::VIEW_LIST)->toArray();
    }
