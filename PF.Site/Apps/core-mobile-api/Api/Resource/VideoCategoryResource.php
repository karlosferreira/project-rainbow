...
class VideoCategoryResource extends ResourceBase
{
    const RESOURCE_NAME = "video-category";
    ...
    public function getSubs()
    {
        if (!empty($this->rawData['sub'])) {
            ...
            foreach ($this->rawData['sub'] as $sub) {
                $subs[] = VideoCategoryResource::populate($sub)->displayShortFields()->toArray();
            }
            return $subs;
        }
        return null;
    ...
    public function getMobileSettings($params = [])
    {
        ...
        $permission = NameResource::instance()->getApiServiceByResourceName(VideoResource::RESOURCE_NAME)->getAccessControl()->getPermissions();
