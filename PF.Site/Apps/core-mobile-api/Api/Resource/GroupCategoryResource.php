...
class GroupCategoryResource extends ResourceBase
{
    const RESOURCE_NAME = "group-category";
    ...
    public function getMobileSettings($params = [])
    {
        ...
        $permission = NameResource::instance()->getApiServiceByResourceName(GroupResource::RESOURCE_NAME)->getAccessControl()->getPermissions();
