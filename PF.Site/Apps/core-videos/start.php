...
Phpfox_Module::instance()
    ...
    ->addComponentNames('controller', [
        ...
        'v.compile-callback' => Controller\CompileCallbackController::class,
        'v.mux-callback' => Controller\MuxCallbackController::class,
...
group('/v', function () {
    ...
    route('/compile-callback/', 'v.compile-callback');
    route('/mux-callback', 'v.mux-callback');
    // old video route
    route('/manage/', 'v.edit');
    // new video route
    route('/edit/', 'v.edit');
