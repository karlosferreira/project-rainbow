                ...
                <div class="item-media hide js_core_photo_drag_sort ui-sortable-handle">
                    ...
                    {if !isset($bSingleMode)}
                        <span class="item-delete hide">
                            ...
                            <input type="checkbox" name="val[{$aForms.photo_id}][delete_photo]" value="{$aForms.photo_id}" class="v_middle close_warning" />
                        </span>
                    {/if}
                        ...
                        <div class="item-inner">
                            {if count($aAlbums)}
                                <div class="form-group">
                                    ...
                                    <select id="{$aForms.photo_id}" name="val[{$aForms.photo_id}][move_to]" class="form-control close_warning">
                            ...
                            {if (empty($bIsEditMode) || empty($aForms.parent_user_id)) && ($aForms.album_id == '0' || $aForms.type_id == '1') && $aForms.group_id == '0' && Phpfox::isModule('privacy')}
                                    ...
                                    <div class="form-group form-group-follow special_close_warning">
                                        ...
                                        <div id="js_custom_privacy_input_holder_{$aForms.photo_id}">
                                            {if isset($bIsEditMode)}
                                                {if empty($aForms.parent_user_id)}
