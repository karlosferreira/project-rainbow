...
class Tag extends Phpfox_Service
{
    ...
    public function getJavascript($iPhotoId)
    {
        ...
        foreach ($aTags as $aTag) {
            $sContentTag = isset($aTag['content']) ? Phpfox::getLib('parse.output')->clean($aTag['content']) : null;
            $sNotes .= '{';
