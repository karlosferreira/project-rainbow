...
<div class="item-rss-outer">
	...
	{foreach from=$aFeeds item=aFeed}
		...
		<li><div class="item-action-parent"><a role="button" class="no_ajax_link"><span class="ico ico-rss-square"></span>{_p var=$aFeed.title_var}</a><a href="#item-rss-collapse-child-list-{$aFeed.feed_id}" data-toggle="collapse" class="item-collapse-icon"><span class="ico ico-angle-up"></span></a></div>
