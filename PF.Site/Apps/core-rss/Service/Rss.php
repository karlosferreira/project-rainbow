...
class Rss extends Phpfox_Service
{
    ...
    public function getForEdit($iId)
    {
        ...
        foreach ($aLanguages as $aLanguage) {
            $aFeed['title_var_' . $aLanguage['language_id']] = _p($aFeed['title_var'], [], $aLanguage['language_id']);
            $aFeed['description_var_' . $aLanguage['language_id']] = _p($aFeed['description_var'], [], $aLanguage['language_id']);
        }
    ...
    public function getFeeds()
    {
        ...
        if (($aFeeds = $this->cache()->get($sCacheId)) === false) {
            $aFeeds = [];
