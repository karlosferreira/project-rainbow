...
class Process extends Phpfox_Service
{
    ...
    public function add($aVals)
    {
        ...
        $selectCustomGender = $aVals['gender'] == 'custom';
        ...
        $aInsertAnnouncement = array(
            ...
            'gender' => $selectCustomGender ? self::CUSTOM_GENDER_VALUE :  (int)$aVals['gender'],
            ...
            'custom_gender' => $selectCustomGender && !empty($aVals['custom_gender']) && is_array($aVals['custom_gender']) ? serialize($aVals['custom_gender']) : null,
        );
    ...
    public function update($aVals, $iId)
    {
        ...
        if ($bSuccess) {
            $this->cache()->remove('announcements');
            $this->cache()->remove('announcement_' . (int)$iId);
            return true;
        } else {
            return false;
        }
