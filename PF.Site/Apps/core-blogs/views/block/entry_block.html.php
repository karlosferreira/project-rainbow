...
<div class="blog-item">
    <div class="item-outer">
        {if !empty($aItem.image)}
            <!-- image -->
            <a class="item-media-src" href="{if empty($aItem.sponsor_id)}{permalink module='blog' id=$aItem.blog_id title=$aItem.title}{else}{url link='ad.sponsor' view=$aItem.sponsor_id}{/if}">
