...
{/if}
{if $aItem.canDelete}
	<li class="item_delete"><a href="javascript:void(0)" onclick="$Core.jsConfirm({l}message: oTranslations['are_you_sure_you_want_to_delete_this_blog_permanently']{r}, function(){l}$.ajaxCall('blog.delete', 'blog_id={$aItem.blog_id}{if isset($bIsDetail)}&is_detail=1{/if}');{r}, function(){l}{r}); return false;" title="{_p var='delete_blog'}"><span class="ico ico-trash-o mr-1"></span>{_p var='delete'}</a></li>
{/if}
