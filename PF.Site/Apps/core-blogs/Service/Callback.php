...
class Callback extends Phpfox_Service
{
     ...
     * @return array
     */
    public function getTagSearch($aConds, $sSort)
    {
    ...
    public function getActivityFeedComment($aRow)
    {
        ...
        $aItem = db()->select('b.blog_id, b.title, b.time_stamp, b.total_comment, b.total_like, b.module_id, b.item_id, c.total_like, ct.text_parsed AS text, ' . Phpfox::getUserField())
    ...
    public function processCommentModeration($sAction, $iId)
    {
        ...
        if ($sAction == 'approve') {
            ...
            Phpfox::getLib('mail')->to($aBlog['comment_user_id'])
                ...
                ])->notification('comment.add_new_comment')->send();
        }
...
//        ];
    ...
    {
        if (!Phpfox::getService('pages')->hasPerm($aPage['page_id'],
                'blog.share_blogs') || !Phpfox::getUserParam('blog.add_new_blog') || !Phpfox::getService('blog')->checkLimitation()) {
            return null;
        }
    ...
    public function processInstallRss()
    {
        ...
        (new \Apps\Core_Blogs\Installation\Version\v468())->importToRssFeed();
    }

    public function getNotificationSettings()
    {
        return [
            'blog.email_notification' => [
                'phrase' => _p('blogs_notifications'),
                'default' => 1
            ]
        ];
    }
