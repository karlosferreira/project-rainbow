    ...
    private function _get($iParentId, $iActive = null)
    {
        ...
        if (count($aCategories)) {
            ...
            if ($this->_sDisplay == 'option') {
                ...
                $this->_sOutput .= '<div class=""><select class="js_mp_category_list form-control close_warning" name="val[category][]" class="js_mp_category_list" id="js_mp_id_' . $iParentId . '">' . "\n";
