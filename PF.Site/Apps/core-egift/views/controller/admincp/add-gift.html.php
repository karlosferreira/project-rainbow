...
<form action="{url link='admincp.egift.add-gift'}" method="post" id="core_js_egift_form" onsubmit="{$sGetJsForm}; $Core.onSubmitForm(this, true);" enctype="multipart/form-data">
    <div class="panel panel-default">
        {if $bIsEdit}
            ...
            <input type="hidden" name="val[name]" value="{$aForms.title}" />
        {/if}
        <div class="panel-body">

            {field_language phrase='title' class='form-control' label='title' field='title' format='val[name_' size=30 maxlength=255 required=true}
