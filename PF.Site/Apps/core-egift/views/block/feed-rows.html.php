...
<div class="egift-item">
    ...
    <div class="content-item">
        <span class="user-from">{$aInvoice.send_from|user}</span> <span>{_p var='sent__l'}</span> <span class="user-to">{$aInvoice.send_to|user}</span> <span>{_p var='a_gift'}:</span> <span class="gift-title">{_p var=$aInvoice.title}</span>
    </div>
</div>