...
class Process extends Core_Service_Systems_Category_Process
{
    ...
    public function addInvoice($iRefId, $iUserTo, $aEgift)
    {
        ...
        if ($aReceivedUser['birthday_search'] && (date('d/m', $aReceivedUser['birthday_search']) == date('d/m',
                    time()))) {
            $aInsert['birthday_id'] = db()->insert(Phpfox::getT('friend_birthday'), [
    ...
    {
        return Phpfox::getService('egift.category.process')->deleteCategory($iId, ['delete_type' => 1]);
    }
