...
class Newsletter extends Phpfox_Service
{
    ...
    public function get($iId = null)
    {
        ...
        $aNewsletters = db()->select('n.*, n.country_iso as news_country_iso, n.gender as news_gender, n.user_group_id as news_user_group_id, nt.*, ' . Phpfox::getUserField())
            ->from($this->_sTable, 'n')
    ...
    public function __call($sMethod, $aArguments)
    {
         ...
         */
        if ($sPlugin = Phpfox_Plugin::get('newsletter.service_newsletter__call')) {
            eval($sPlugin);
            return null;
        }
