...
class AddController extends Admincp_Component_Controller_App_Index
{
    ...
    public function process()
    {
        ...
        if ($iEditId = $this->request()->getInt('newsletter_id')) {
            ...
            $aNewsletter['gender'] = $aNewsletter['news_gender'];
            $aNewsletter['country_iso'] = $aNewsletter['news_country_iso'];
            if (!empty($aNewsletter['country_iso'])) {
                $this->setParam('country_child_value', $aNewsletter['country_iso']);
            }
