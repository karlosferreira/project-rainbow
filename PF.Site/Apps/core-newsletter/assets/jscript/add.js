...
$Behavior.newsletter_add_init = function () {
    $('#age_from').off('change').change(function () {
        if (!empty(this.value) && $('#age_to option:selected').val() != '' && parseInt(this.value) > parseInt($('#age_to option:selected').val())) {
            $(this).val('');
    ...
    $('#age_to').off('change').change(function () {
        if (!empty(this.value) && $('#age_from option:selected').val() && parseInt($(this).val()) < parseInt($('#age_from option:selected').val())) {
            $(this).val('');
