...
<div id="js_main_mail_thread_holder" class="core-messages__title-conversation js_conversation_popup_main">
    ...
    <div class="mail-messages js_mail_messages_content dont-unbind-children open-popup" id="js_conversation_content_popup" data-id="{$aThread.thread_id}">
...
<script type="text/javascript">
    $Behavior.conversation_popup = function() {
        ...
        {
            setTimeout(function () {
                if($('.js_conversation_popup_main').find('.js_mail_messages_content:not(".built")').length) {
                    var messagePopupContent =   $('.js_conversation_popup_main').find('.js_mail_messages_content:not(".built")');
                    messagePopupContent.mCustomScrollbar('scrollTo','bottom',{scrollInertia:0});
                    messagePopupContent.addClass('built');
                }
