...
<div class="table-responsive panel panel-default groups-manage-categories">
    ...
    <table class="table table-admin" id="js_drag_drop" cellpadding="0" cellspacing="0" data-app="core_groups" data-action-type="init" data-action="init_drag" data-table="#js_drag_drop" data-ajax="{if $bSubCategory}groups.categorySubOrdering{else}groups.categoryOrdering{/if}">
        <thead>
            <tr class="nodrop">
                <th class="w20"></th>
                <th class="w20"></th>
