    ...
    private function _updateProfileCoverPhotos()
    {
        ...
        foreach ($aPages as $aPage) {
            ...
            if ($aPage['image_path']) {
                ...
                db()->update(':photo_album', ['module_id' => 'groups', 'group_id' => $aPage['page_id']],
                    ['profile_id' => $iUserId]);
                // update profile images
                db()->update(':photo', ['module_id' => 'groups', 'group_id' => $aPage['page_id']],
            ...
            if ($aPage['cover_photo_id']) {
                ...
                db()->update(':photo',
                    ['module_id' => 'groups', 'group_id' => $aPage['page_id'], 'album_id' => $iCoverAlbumId],
