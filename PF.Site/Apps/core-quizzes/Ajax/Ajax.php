...
class Ajax extends Phpfox_Ajax
{
    ...
    public function moderation()
    {
        ...
        switch ($this->get('action')) {
            ...
            case 'delete':
                ...
                $sMessage = _p('quiz_zes_successfully_deleted');
                break;
            case 'feature':
    ...
    public function sponsor()
    {
        ...
        if (\Phpfox::getService('quiz.process')->sponsor($this->get('quiz_id'), $this->get('type'))) {
            ...
            $this->alert($this->get('type') == '1' ? _p('quiz_successfully_sponsored') : _p('quiz_successfully_un_sponsored'),null,300,150,true);
        }
