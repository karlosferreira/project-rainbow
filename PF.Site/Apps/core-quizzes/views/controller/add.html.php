...
<div id="js_add_quiz_container">
    ...
    <form method="post" action="{url link='current'}" id="js_add_quiz_form" name="js_add_quiz_form" {if $bShowTitle}onsubmit="{$sGetJsForm}"{/if} {if Phpfox::getUserParam('quiz.can_upload_picture')}enctype="multipart/form-data"{/if}>
        <div id="js_custom_privacy_input_holder">
        {if isset($aQuiz.quiz_id) && empty($sModule) && Phpfox::isModule('privacy')}
