...
{if $aQuiz.canSponsor}
    <li>
        <a href="javascript:void()" id="js_sponsor_{$aQuiz.quiz_id}" class="{if $aQuiz.is_sponsor != 1}hide{/if}" onclick="$('#js_sponsor_{$aQuiz.quiz_id}').removeClass('hide');$('#js_unsponsor_{$aQuiz.quiz_id}').addClass('hide');$.ajaxCall('quiz.sponsor','quiz_id={$aQuiz.quiz_id}&type=0', 'GET'); return false;">
            <i class="ico ico-sponsor mr-1"></i>{_p var='unsponsor_this_quiz'}
        </a>
        <a href="javascript:void()" id="js_unsponsor_{$aQuiz.quiz_id}" class="{if $aQuiz.is_sponsor == 1}hide{/if}" onclick="$('#js_sponsor_{$aQuiz.quiz_id}').addClass('hide');$('#js_unsponsor_{$aQuiz.quiz_id}').removeClass('hide');$.ajaxCall('quiz.sponsor','quiz_id={$aQuiz.quiz_id}&type=1', 'GET'); return false;">
...
{elseif $aQuiz.canPurchaseSponsor}
    {if $aQuiz.is_sponsor == 1}
        <li>
            <a href="#" onclick="$('#js_sponsor_{$aQuiz.quiz_id}').hide();$('#js_unsponsor_{$aQuiz.quiz_id}').show();$.ajaxCall('quiz.sponsor','quiz_id={$aQuiz.quiz_id}&type=0', 'GET'); return false;">
