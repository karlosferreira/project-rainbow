...
{if isset($bIsViewingQuiz)}
	<div class="item_info pr-3">
	    {img user=$aQuiz suffix='_120_square'}
	...
	<div class="item-content">
        ...
        <div class="item_view_content">
            {$aQuiz.description|parse|shorten:200:'feed.view_more':true|split:55}
        </div>
    </div>
					...
					<div class="quiz_user_list">
						<div class="quiz_user_list_left">
							...
							<div class="quiz_user_image">
								{img user=$aUser.user_info suffix='_120_square' max_width=50 max_height=50}
