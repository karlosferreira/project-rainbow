                    ...
                    <div class="item-price">
                        <div class="item-price-first">
                            ...
                            <span class="item-cost">
                                ...
                                {elseif isset($aPackage.price)}
                                    {foreach from=$aPackage.price item=price name=iCost}
                                        <span class="subscription-price">{$price.cost|currency:$price.currency_id}</span>
                                    {/foreach}
                                {else}
                                    {_p var='free'}
                                {/if}
                        ...
                        {if $aPackage.recurring_period}
                            <div class="item-price-recurring">
                                ...
                                <span class="item-cost">
                                    {$aPackage.default_recurring_cost_no_phrase|currency:$aPackage.default_currency_id}
                                </span>
                            </div>
                        {/if}
                    </div>
