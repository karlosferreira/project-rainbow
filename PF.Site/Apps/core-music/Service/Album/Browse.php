...
class Browse extends \Phpfox_Service
{
    ...
    public function query()
    {
        ...
        if ($this->isApi) {
            db()->select((Phpfox::getParam('core.allow_html') ? 'matext.text_parsed' : 'matext.text') . ' AS text, ')
                ->join(':music_album_text', 'matext', 'matext.album_id = m.album_id');
        }
    }
