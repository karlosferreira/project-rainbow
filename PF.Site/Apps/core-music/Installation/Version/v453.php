...
class v453
{
    ...
    public function process()
    {
        ...
        // Update old settings
        $aSettingsSponsorSong = [
            'limit'      => Phpfox::getParam('music.sponsored_songs_to_show', 10),
            'cache_time' => Phpfox::getParam('core.cache_time_default'),
        ];
        db()->update(':block', ['params' => json_encode($aSettingsSponsorSong)], 'component = \'sponsored-song\' AND module_id = \'music\' AND params IS NULL');
