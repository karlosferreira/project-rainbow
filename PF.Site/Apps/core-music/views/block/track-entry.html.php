	...
	<div class="item-outer">
		...
		<div class="music-download-action {if !$aSong.canDownload}disable-download{/if}">
            ...
            <div class="dropdown js_music_dropdown_add_to_playlist">
                <span role="button" class="row_edit_bar_action" data-toggle="dropdown" data-song-id="{$aSong.song_id}" onclick="$Core.music.loadUserPlaylist(this, {if !empty($bFixPopup)}{$bFixPopup}{/if});">
