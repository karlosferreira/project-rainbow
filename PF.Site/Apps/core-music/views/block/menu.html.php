...
{elseif $aSong.canPurchaseSponsor}
    {if $aSong.is_sponsor}
    <li id="js_sponsor_purchase_music_song_{$aSong.song_id}">
        <a href="#" onclick="$('#js_sponsor_phrase_{$aSong.song_id}').hide(); $.ajaxCall('music.sponsorSong','song_id={$aSong.song_id}&type=0', 'GET'); return false;">
