    ...
    <div class="item-outer song">
        ...
        <div class="item-inner song">
            <div class="item-title">
                <a href="{if empty($aSong.sponsor_id)}{permalink module='music' id=$aSong.song_id title=$aSong.title}{else}{url link='ad.sponsor' view=$aSong.sponsor_id}{/if}">{$aSong.title|clean}</a>
            </div>
