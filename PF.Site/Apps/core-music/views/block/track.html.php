...
<script type="text/javascript">
    ...
    $Behavior.onLoadAlbumSong = function(){
        $('#js_music_add_to_playlist_dropdown').remove();
        $('body').append('<div class="music-add-to-playlist-dropdown" id="js_music_add_to_playlist_dropdown" style="display: none"><ul class="dropdown-menu dropdown-menu-right" id="js_music_playlist_dropdown_menu"><div class="form-spin-it p-1 t_center"><i class="fa fa-spin fa-circle-o-notch"></i></div></ul></div>');
