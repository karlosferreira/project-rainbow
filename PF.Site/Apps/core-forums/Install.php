    ...
    protected function setSettings()
    {
        $this->settings = [
            ...
            'forum_allow_create_feed_when_add_new_item' => [
                'var_name' => 'forum_allow_posting_on_main_feed',
                'info' => 'Allow posting on Main Feed',
                'description' => 'Allow posting on Main feed when adding a new thread/post.',
                'type' => 'boolean',
                'value' => '1',
                'ordering' => 13
            ],
            'forum_setting_subject_reply_to_thread' => [
                'info' => 'Forums - Email Subject - Someone Replied To Thread',
                'description' => 'Email subject of the "Someone Replied To Thread" notification. <a role="button" onclick="$Core.editMeta(\'reply_to_thread_title\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="reply_to_thread_title"></span>',
                'type' => '',
                'value' => '{_p var="reply_to_thread_title"}',
                'ordering' => 14,
                'group_id' => 'email'
            ],
            'forum_setting_content_reply_to_thread' => [
                'info' => 'Forums - Email Content - Someone Replied To Thread',
                'description' => 'Email content of the "Someone Replied To Thread" notification. <a role="button" onclick="$Core.editMeta(\'full_name_has_just_replied_to_the_thread_title\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="full_name_has_just_replied_to_the_thread_title"></span>',
                'type' => '',
                'value' => '{_p var="full_name_has_just_replied_to_the_thread_title"}',
                'ordering' => 15,
                'group_id' => 'email'
            ],
            'forum_setting_subject_someone_liked_one_of_your_forum_posts' => [
                'info' => 'Forums - Email Subject - Someone Liked Your Post',
                'description' => 'Email subject of the "Someone Liked Your Post" notification. <a role="button" onclick="$Core.editMeta(\'full_name_liked_one_of_your_forum_posts\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="full_name_liked_one_of_your_forum_posts"></span>',
                'type' => '',
                'value' => '{_p var="full_name_liked_one_of_your_forum_posts"}',
                'ordering' => 16,
                'group_id' => 'email'
            ],
            'forum_setting_content_someone_liked_one_of_your_forum_posts' => [
                'info' => 'Forums - Email Content - Someone Liked Your Post',
                'description' => 'Email content of the "Someone Liked Your Post" notification. <a role="button" onclick="$Core.editMeta(\'content_full_name_liked_one_of_your_forum_posts_in\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="content_full_name_liked_one_of_your_forum_posts_in"></span>',
                'type' => '',
                'value' => '{_p var="content_full_name_liked_one_of_your_forum_posts_in"}',
                'ordering' => 17,
                'group_id' => 'email'
            ],
            'forum_setting_subject_your_forum_post_has_been_approved' => [
                'info' => 'Forums - Email Subject - Your Post Has Been Approved',
                'description' => 'Email subject of the "Your Post Has Been Approved" notification. <a role="button" onclick="$Core.editMeta(\'forum_post_approved_on_site_title\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="forum_post_approved_on_site_title"></span>',
                'type' => '',
                'value' => '{_p var="forum_post_approved_on_site_title"}',
                'ordering' => 18,
                'group_id' => 'email'
            ],
            'forum_setting_content_your_forum_post_has_been_approved' => [
                'info' => 'Forums - Email Content - Your Post Has Been Approved',
                'description' => 'Email content of the "Your Post Has Been Approved" notification. <a role="button" onclick="$Core.editMeta(\'your_post_that_is_part_of_the_forum_thread_title_on_site_title\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="your_post_that_is_part_of_the_forum_thread_title_on_site_title"></span>',
                'type' => '',
                'value' => '{_p var="your_post_that_is_part_of_the_forum_thread_title_on_site_title"}',
                'ordering' => 19,
                'group_id' => 'email'
            ],
            'forum_setting_subject_your_forum_thread_has_been_approved' => [
                'info' => 'Forums - Email Subject - Your Thread Has Been Approved',
                'description' => 'Email subject of the "Your Thread Has Been Approved" notification. <a role="button" onclick="$Core.editMeta(\'thread_approved_on_site_title\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="thread_approved_on_site_title"></span>',
                'type' => '',
                'value' => '{_p var="thread_approved_on_site_title"}',
                'ordering' => 18,
                'group_id' => 'email'
            ],
            'forum_setting_content_your_forum_thread_has_been_approved' => [
                'info' => 'Forums - Email Content - Your Thread Has Been Approved',
                'description' => 'Email content of the "Your Thread Has Been Approved" notification. <a role="button" onclick="$Core.editMeta(\'your_thread_title_on_site_title_has_been_approved\', true)">Click here</a> to edit.<span style="float:right;">(Email) <input style="width:150px;" readonly value="your_thread_title_on_site_title_has_been_approved"></span>',
                'type' => '',
                'value' => '{_p var="your_thread_title_on_site_title_has_been_approved"}',
                'ordering' => 19,
                'group_id' => 'email'
            ],
        ];
...
If set to false, the admin will have to approve each new purchased sponsored thread before it is shown in the site.',
            ...
            'approve_forum_thread' => [
                ...
                'info' => 'Threads must be approved first before they are displayed publicly?',
                'description' => '',
                'type' => 'boolean',
                'value' => [
                    '1' => '0',
            ...
            'approve_forum_post' => [
                ...
                'info' => 'Forum posts must be approved first before they are displayed publicly?',
                'description' => '',
                'type' => 'boolean',
                'value' => [
                    '1' => '0',
