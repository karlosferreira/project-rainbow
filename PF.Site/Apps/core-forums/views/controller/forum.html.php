...
{if !PHPFOX_IS_AJAX && count($aThreads) && !$bIsSearch && Phpfox::getParam('forum.enable_rss_on_threads') && Phpfox::getParam('forum.rss_feed_on_each_forum') && Phpfox::isAppActive('Core_RSS')}
