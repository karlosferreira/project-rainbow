...
{if ($aThread.canApprove || $aThread.canEdit || ($aCallback === null && ($aThread.canMove || $aThread.canCopy)) || $aThread.canStick || $aThread.canClose || $aThread.canMerge) && (empty($aThread.is_announcement) || $aThread.canSponsor || $aThread.canPurchaseSponsor || $aThread.canDelete)}
    <li role="separator" class="divider"></li>
{/if}

{if empty($aThread.is_announcement)}
