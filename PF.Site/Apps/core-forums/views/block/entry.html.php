						...
						<div class="item-outer pt-2 pb-2">
							<div class="item-title">
								<h4>
									...
									<a href="{permalink module='forum' id=$aForum.forum_id title=$aForum.name}"{if !empty($aForum.description)} title="{_p var=$aForum.description}" {/if} class="fw-bold forum-text-overflow">{_p var=$aForum.name}</a>
								</h4>
