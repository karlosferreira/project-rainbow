                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="moderators" clas="mb-2">
                            <span>
                                <a href="#" onclick="$Core.browseUsers({literal}{{/literal}input : 'users&bIsAdminCp=true&bOnlyUser=true&fromForumApp=1'{literal}}{/literal}); return false;">{_p var='moderators'}</a>:
                            </span>
                        </label>
                        {if !count($aUsers)}
                        <div><input type="text" class="form-control" name="default_users" id="js_default_users" value="" size="30" onclick="$Core.browseUsers({literal}{{/literal}input : 'users&bIsAdminCp=true&bOnlyUser=true&fromForumApp=1'{literal}}{/literal}); return false;" class="w_95" /></div>
                        {/if}
